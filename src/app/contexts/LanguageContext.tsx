...
'home.vision.description': "To become one of Saudi Arabia's leading groups, recognized for excellence, innovation, and delivering world-class turnkey solutions.",
    ...
    'projects.alyarmook': 'Gems British Int. School',
  ...
  ar: {
    ...
    // About
'about.title': 'عن مجموعة لي بريميير',
'about.subtitle': 'أكثر من عقدين من التميز الموثوق',

'about.p1': 'على مدار أكثر من عشرين عامًا، تقدم مجموعة لي بريميير حلولًا متكاملة في مجالات الإنشاءات، والتصنيع الصناعي، وأنظمة السلامة والحماية من الحريق، والترفيه. ويعكس تنوع أعمالنا التزامنا بالابتكار والجودة والنزاهة، مما يمكننا من تقديم حلول متكاملة مصممة لتلبية متطلبات كل مشروع.',

'about.p2': 'ومن خلال شراكات موثوقة ونهج متعدد التخصصات، نجحنا في تنفيذ مئات المشاريع، مع تقديم قيمة مستدامة لعملائنا، والحفاظ على أعلى معايير الجودة والسلامة والأداء.',
// Home Mission & Vision
...
'home.vision.description': 'أن نكون إحدى المجموعات الرائدة في المملكة العربية السعودية، والمعروفة بالتميز والابتكار وتقديم حلول متكاملة عالمية المستوى.',
    ...
    'projects.alyarmook': 'مدرسة جيمس البريطانية الدولية',
